...
class _HappeningsCarouselState extends State<HappeningsCarousel> {
  ...
  final List<Happening> happenings = [
    Happening(title: "FLOATI'N'MOVIE",
        description: 'Float the night away whilst enjoying a line-up of blockbuster films. You can hire a tube or why not watch the movie poolside on a deck chair. Selected food & drink outlets will be open to indulge in a tasty snack and quench your thirst.',
        tags: '(SPLASH)(CINEMA)(SplashMania)'),
    Happening(title: "TENT-TOBER CAMPING WEEKEND",
        description: 'Join us for an overnight camping experience Saturday evening through Sunday morning. There will be activities to enjoy throughout the evening including campfires, kayaking animal feeding, bird watching, camping gear demonstrations and more.',
        tags: '(NATURE)(Payah Indah Discovery Wetlands)'),
    Happening(title: "RICK ROLL",
        description: 'Never gonna give you up. Never gonna let you down. Never gonna run around and dessert you. Never gonna make you cry. Never gonna say good bye. Never gonna tell a lie and hurt you.',
                ...
                Builder(
                  builder: (context){
                    return CarouselSlider(
                        ...
                        items: happenings
                            .map((item) => _happeningCard(item.title, item.description, item.tags))
                            .toList(),
                ...
                Row(
                  ...
                  children: happenings.asMap().entries.map((entry) {
                    return GestureDetector(
                      onTap: () => _controller.animateToPage(entry.key, duration: const Duration(milliseconds: 200)),
                      child: Container(
                        width: 10.0,
                        height: 10.0,
